...
= 1.8.2 =
- Fix button text
- Fix login and register showing at the same time
- Fix flash of unstyled content

= 1.8.1 =
- Fix number with unit fields

= 1.8 =
- Toggle password visibility

= 1.7.2 =
- Fixes for Material Design
...
= 1.6.2 =
- Improved automatic scrolling behavior
...
= 1.4.1 =
- Ask for name when using standard login credentials + email

= 1.4 =
- Support for all different folder structures
- Bug fixes

= 1.3 =
- Option to ask for an email address when using standard login credentials
